     ...
     class="table table-bordered table-striped">
                  ...
                  <tbody>
                            ...
                            <tr>
                                ...
                                <input type='hidden' value='0' name='designation'>
                                <input type='hidden' value='<?php echo $row['employee_data_id']; ?>' name='employee_data_id'>
                                <input type="checkbox" name='designation' value='1' data-toggle="switchbutton" checked data-onlabel="Active" data-offlabel="Inactive"  onChange='submit();' checked>
